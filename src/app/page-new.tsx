    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-8">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600">Upload images using Netlify serverless functions</p>
        </div>
            ...
            {preview && (
              <div className="space-y-4">
                ...
                <div className="relative w-full max-w-md mx-auto">
                  <Image src={preview} alt="Preview" width={400} height={300} className="rounded-lg shadow-md object-cover" />
                </div>
              ...
              <div className={`p-4 rounded-lg ${uploadResult.success ? "bg-green-50 border border-green-200" : "bg-red-50 border border-red-200"}`}>
                ...
                {uploadResult.success && uploadResult.fileId && (
                  <div className="mt-3 text-sm text-green-700">
                    ...
                    <p>
                      <strong>Uploaded:</strong> {uploadResult.uploadedAt && new Date(uploadResult.uploadedAt).toLocaleString()}
                    </p>
                  </div>
                )}
